...
void process_own_Ql1(struct Q * list[]){
  ...
  while (tempdat != NULL){
    ...
    printf("%d,%d,%.10f,%.10f,%.10f,%d,OWN,LOOP1,%d\n",tempdat->start,tempdat->end,t1 - t0,t0,t1,ID,N_Threads);
...
void process_own_Ql2(struct Q * list[]){
  ...
  while (tempdat != NULL){
    ...
    double t1 = omp_get_wtime();
    printf("%d,%d,%.10f,%.10f,%.10f,%d,OWN,LOOP2,%d\n",tempdat->start,tempdat->end,t1 - t0,t0,t1,ID,N_Threads);
...
void process_other_Qsl1(struct Q * list[]){
  ...
  while (tempdat!=NULL){
    ...
    loop1(tempdat->start,tempdat->end);
    double t1 = omp_get_wtime();
    printf("%d,%d,%.10f,%.10f,%.10f,%d,STOLEN,LOOP1,%d\n",tempdat->start,tempdat->end,t1 - t0,t0,t1,ID,N_Threads);
...
void process_other_Qsl2(struct Q * list[]){
  ...
  while (tempdat!=NULL){
    ...
    loop2(tempdat->start,tempdat->end);
    double t1 = omp_get_wtime();
    printf("%d,%d,%.10f,%.10f,%.10f,%d,STOLEN,LOOP2,%d\n",tempdat->start,tempdat->end,t1 - t0,t0,t1,ID,N_Threads);
